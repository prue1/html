const items = {
    'i01': { category: 'item', name: '藥草', price: 3, image: 'hp-potion.png' },
    'i02': { category: 'item', name: '金創藥', price: 5, image: 'hp-potion.png' },
    'i03': { category: 'item', name: '小還丹', price: 10, image: 'hp-potion.png' },
    'i04': { category: 'item', name: '大還丹', price: 15, image: 'hp-potion.png' },
    'i05': { category: 'item', name: '解毒丹', price: 5, image: 'hp-potion.png' },
    'i06': { category: 'item', name: '小復活丹', price: 10, image: 'hp-potion.png' },
    'i07': { category: 'item', name: '大復活丹', price: 20, image: 'hp-potion.png' },
    'i08': { category: 'item', name: '行氣散', price: 12, image: 'hp-potion.png' },
    'i09': { category: 'item', name: '加速丹', price: 13, image: 'hp-potion.png' },
    'i10': { category: 'item', name: '防禦丹', price: 17, image: 'hp-potion.png' },
    'i11': { category: 'item', name: '辟邪丹', price: 20, image: 'hp-potion.png' },
    'i12': { category: 'item', name: '天香斷續膏', price: 9, image: 'hp-potion.png' },
    'i13': { category: 'item', name: '迷香', price: 9, image: 'hp-potion.png' },
